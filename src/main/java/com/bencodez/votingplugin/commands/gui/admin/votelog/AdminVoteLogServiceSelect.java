...
/**
 * Admin GUI: Select a service (distinct list), then open AdminVoteLogService.
 */
public class AdminVoteLogServiceSelect extends GUIHandler {
	...
	/**
	 * Constructor for AdminVoteLogServiceSelect.
	 *
	...
	private BInventoryButton makeServiceButton(final String service) {
